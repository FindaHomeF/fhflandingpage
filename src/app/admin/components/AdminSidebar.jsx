    ...
    <>
      ...
      {isOpen && (
        ...
        />
             ...
             {/* Sidebar */}
       <div className={`fixed inset-y-0 left-0 z-[9999] bg-white min-w-64 h-screen  shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
        <nav className="pt-7 px-2 ">
        
            <div className="logo-container w-full h-[5rem]">
              <Link href={'/admin'}>
                <Image src={Logo}
                alt="fhflogo"
                width={200}
