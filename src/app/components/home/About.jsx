    ...
    <div className="w-full">
        <div className="w-[90%] md:w-5/6 mx-auto space-y-7">
            <div className="flex justify-between gap-x-20">
                ...
                <p className="text-base font-semibold w-3/6">
            ...
            <div>
                <div className="flex justify-between w-full items-stretch flex-shrink-0">
                    <div className="border-l-2 border-l-black space-y-1 px-5 w-2/6 pt-3">
                        ...
                        <h6 className="uppercase font-semibold text-base ">ITEMS SOLD</h6>
                    </div>
                    <div className="border-l-2 border-l-black space-y-1 px-5 w-2/6 pt-3">
                        <h3 className="text-4xl font-bold">30+</h3>
                        <h6 className="uppercase font-semibold text-base ">Trusted Agents, Landlords, and Service Providers</h6>
                    </div>
                    <div className="border-l-2  border-l-black space-y-1 px-5 w-2/6 pt-3">
                        <h3 className="text-4xl font-bold">200+</h3>
                        <h6 className="uppercase font-semibold text-base "> Students Provided with Accommodation Options</h6>
                    </div>
                </div>
            </div>
