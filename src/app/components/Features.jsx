            ...
            <div className="features-container flex flex-wrap md:flex-nowrap gap-y-5 items-center justify-between gap-x-10">
                <div className="features-box-outer bg-[#F9FAFB] rounded-2xl p-5">
                    ...
                    <div>
                        ...
                        <p className='text-sm md:text-base text-[#00010399]'>Provides a comprehensive and detailed overview of your rental property, showcasing its best features, and amenities.</p>
                    </div>
                </div>
