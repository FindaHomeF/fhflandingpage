...
const HeroSection = () => {
  return (
    <div className="hero-outer w-full space-y-10 md:bg-transparent md:h-fit h-[85vh] flex md:block justify-center items-center">
        <div className="hero-inner w-5/6 md:w-4/6 mx-auto text-center space-y-2 md:space-y-3 pt-3 md:pt-12 md:bg-none">
            ...
            <div className="md:hidden pt-20 flex justify-center items-center w-full">     
                <CiCircleChevDown className="animate-bounce text-5xl text-[#0d27409d]"/>
            </div>
        </div>
