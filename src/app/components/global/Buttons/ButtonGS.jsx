...
export const UnlockBtn = ({text}) => {
  return (
    <Button className="Capitalize bg-white rounded-full h-[3rem] md:h-[3.375rem] w-fit text-base font-medium text-[#0D2740] flex items-center">{text}<span className="bg-white rounded-full p-1 border border-[#0D2740]"><GoArrowUpRight size={15}/></span></Button>
  )
}
